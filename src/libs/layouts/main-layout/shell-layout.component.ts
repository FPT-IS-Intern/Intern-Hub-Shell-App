...
export class ShellLayoutComponent {
  ...
  headerData = {
    ...
    userIconColor: 'var(--brand-600)',
    dropdownIcon: 'dsi-arrow-down-solid',
    dropdownIconColor: 'var(--brand-600)',
    ...
    menuItems: [
      {
        ...
        colorIconLeftHover: 'var(--brand-600)',
      ...
      },
      {
        ...
        colorIconLeft: 'var(--neutral-color-100)',
        colorIconLeftHover: 'var(--brand-600)',
        iconRight: 'dsi-chevron-right-line',
        colorIconRight: 'var(--neutral-color-400)',
      },
      {
        iconLeft: 'dsi-logout-line',
        content: 'Đăng xuất',
        colorIconLeft: 'var(--neutral-color-100)',
        colorIconLeftHover: 'var(--brand-600)',
        colorContent: 'var(--brand-600)',
      },
    ],
  };
